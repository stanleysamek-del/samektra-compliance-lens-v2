...
- YELLOW tag = a deficiency / non-conformance was identified at last inspection. THIS IS A REAL DEFICIENCY — must be addressed. The visible side typically shows test date and inspector signature; the deficiency itself is documented on the BACK of the tag. → Medium, Fire, NFPA 25 §3.3. Description: "Yellow inspection tag indicates a deficiency was identified at the last inspection that has not been resolved. Flip the tag to read the recorded deficiency on the reverse." Add whatToLookFor: "Read back of yellow tag for the documented deficiency" and "Verify deficiency was remediated or is scheduled for remediation". Bbox the tag.
